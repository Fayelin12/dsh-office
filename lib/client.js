window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      // 悬浮会话边框色（按状态）：待确认黄 / 进行中蓝 / 已完成绿 / 其他灰
      const ACCENT = {
        pending: "rgb(255, 179, 10)",
        running: "rgb(84, 138, 242)",
        completed: "rgb(41, 203, 81)",
        other: "rgb(174, 174, 178)"
      };
        ...
        return React.createElement("div", {
          ...
          notice ? React.createElement("div", {
            ...
            style: {
              ...
              padding: "8px 12px", borderRadius: BORDER_RADIUS_BUTTON,
              border: "1.5px solid rgb(255, 179, 10)",
              background: "var(--dsw-alias-bg-layer-1, #ffffff)",
              boxShadow: SHADOW_BUTTON,
              boxSizing: "border-box",
              animation: "officeNoticeIn .3s ease, officeNoticeOut .4s ease 11.6s forwards"
            }
          },
            React.createElement("span", { style: { fontSize: 16, lineHeight: 1, flexShrink: 0 } }, "📢"),
            React.createElement("div", {
              style: { display: "flex", flexDirection: "column", minWidth: 0, flex: "1 1 auto" }
            },
              React.createElement("span", {
                style: {
                  display: "block", fontSize: 11, lineHeight: "14px", fontWeight: 600,
                  color: "var(--dsw-alias-label-secondary, #6e6e73)",
                  overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap"
                }
              }, "飞书@" + (notice.chat || "你")),
              React.createElement("span", {
                title: (notice.sender ? notice.sender + "：" : "") + (notice.snippet || ""),
                style: {
                  display: "block", fontSize: 12, lineHeight: "16px", fontWeight: 500,
                  color: "var(--dsw-alias-label-primary, #1c1c1e)",
                  overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap"
                }
              },
                truncateText((notice.sender ? notice.sender + "：" : "") + (notice.snippet || ""), 40)
              )
            )
          ) : null,
          ...
          nearest ? React.createElement("button", {
            ...
            style: {
              ...
              border: "1.5px solid " + ((nearest.start_ts || 0) <= Date.now() ? "rgb(41, 203, 81)" : "rgb(255, 179, 10)"),
